...
def main():
    ...
    parser.add_argument("--columns", type=int, default=8, help="Cards per row")
    parser.add_argument("--thumb-width", type=int, default=220, help="Max screenshot width")
    parser.add_argument("--thumb-height", type=int, default=360, help="Max screenshot height")
